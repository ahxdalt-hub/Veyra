...
export const metadata: Metadata = {
  title: "Refund Policy",
  description:
    "Veyra refunds: 4 days, no interrogation. The full policy in plain language.",
      ...
      sections={[
        {
          ...
          body: (
            <p>
              Contact us within <strong className="text-ink">4 days</strong> of
