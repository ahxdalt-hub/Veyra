        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-ink-3">
              One product, one payment, delivered digitally. You&rsquo;ll
            ...
            {phase === "not-configured" ? (
              ...
              <form onSubmit={onPay} className="mt-8 max-w-md" noValidate>
                <Input
                  type="email"
                  name="email"
                  autoComplete="email"
                ...
                <p className="mt-3 text-center text-xs text-ink-4">
                  Processed by Razorpay · 14-day refund window
                </p>
              </form>
            )}
            ...
            <div className="rounded-md border border-line bg-surface p-6 shadow-sm">
              ...
              <div className="mt-5 flex gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-2 spec text-ink-4">Digital delivery</p>
                </div>
              </div>
              ...
              <dl className="mt-6 space-y-2 border-t border-line pt-4 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <dd className="tnum text-ink-2">{formatPrice(total)}</dd>
                </div>
              ...
              <ul className="mt-6 space-y-2.5 border-t border-line pt-5">
                {[
                  ...
                  "Delivered digitally after payment is confirmed",
